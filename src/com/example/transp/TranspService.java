...
public class TranspService {
	...
	// distances[i, j] is a distance from plant i to market j in thousands of miles
	...
	public Plant[] plants() { return plants; }
	public Market[] markets() { return markets; }
	public double[] distances() { return distances; }
	public double freight() { return freight; }
